...
%   The appropriate syntax depends on the number of parameters in
...
%   'weib' or 'Weibull'.
%
%   Both M and N are integers.  Alternatively you can omit N and
%   specify M as a vector of two integers.  If you omit both M and
%   N, then R is a 1-by-1 array.

%   RANDOM calls many specialized routines that do the calculations. 

%   D. Zwillinger 5-91, B. Jones 10-92
%   Copyright 1993-2000 The MathWorks, Inc. 
% $Revision: 2.11 $  $Date: 2000/05/26 18:53:31 $
