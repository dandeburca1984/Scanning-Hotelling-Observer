function [test_stat position] = get_hot_grid_contracing_old(r_cov,r_data,PSF,star_location,a_pl,planet_position_start)
...
position(1,1) = (position_tmp(1,1)-sampling_2) + (position_(1,1) * sampling_2);
position(1,2) = (position_tmp(1,2)-sampling_2)+ (position_(1,2) * sampling_2);
